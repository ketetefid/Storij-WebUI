...
$setup_sc = shell_exec('source /boot/storij/parameters.txt; echo $setup_sc');
$siadir = shell_exec('source /boot/storij/parameters.txt; echo $SCDIR');
...
$rpc_port = shell_exec('source /boot/storij/parameters.txt; echo $sc_rpc_port');
$host_port = shell_exec('source /boot/storij/parameters.txt; echo $sc_host_port');
$auto_unlock = shell_exec('source /boot/storij/parameters.txt; echo $sc_auto_unlock');
