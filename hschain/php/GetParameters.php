...
$setup_xsc = shell_exec('source /boot/SiaBerry/parameters.txt; echo $setup_xsc');
...
$rpc_port = shell_exec('source /boot/SiaBerry/parameters.txt; echo $xsc_rpc_port');
$host_port = shell_exec('source /boot/SiaBerry/parameters.txt; echo $xsc_host_port');
$auto_unlock = shell_exec('source /boot/SiaBerry/parameters.txt; echo $xsc_auto_unlock');
