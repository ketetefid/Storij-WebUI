...
$apihcurl = 'http://localhost:9980/host';
$chh = curl_init();
curl_setopt($chh, CURLOPT_USERAGENT, "Sia-Agent");
...
$apihscurl = 'http://localhost:9980/host/estimatescore';
$chhs = curl_init();
curl_setopt($chhs, CURLOPT_USERAGENT, "Sia-Agent");
