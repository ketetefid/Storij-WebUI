...
$(document).ready(function(){
	...
	$("#initWalletModal").show();
	$("#initWalletInfo").html("<p> Enter the seed whose Siacoins are to be swept into your wallet:</p>");
	// Calculating the best width of the text area based on the screen/parent width
	var optwidth=$("#initWalletInfo").width()-40;
...
$(document).ready(function(){
	...
	$('#SiaTable').html('<table id="wait4sia" class="t1"><tr><td><div class="HostConfigItems" style="justify-content:center">Please wait until Sia daemon has started...<i class="fa fa-cog fa-spin fa-2x fa-fw"></i></div></td></tr></table>').show();
